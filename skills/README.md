...
- `message-queue/SKILL.md` — file-based FIFO queue for deferring user input during mid-task dispatch
...
- `secops-engineer-self-review/SKILL.md` — PROOF self-review rubric — technical assessment quality gate
- `secops-manager-self-review/SKILL.md` — CLEAR self-review rubric — management report quality gate
- `security-assessment/SKILL.md` — engagement methodology — scope gate, black/gray/white-box, full lifecycle
- `security-knowledge/SKILL.md` — continuous security intelligence — read, refresh, and grow the knowledge base
- `security-report/SKILL.md` — Kolivo report standard — technical and management reports, reproducible from zero
- `security-testing/SKILL.md` — active testing catalog — per-mode checklists and controlled-exploitation discipline
